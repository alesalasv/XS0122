...
-   **Información importante**
    ...
    2.  [Programa del curso](https://christopher-tr.github.io/XS0122-II_2025/XS-0122%20carta%20al%20estudiante.pdf)

    3.  [Llenar el formulario (pendiente)](https://docs.google.com/forms/d/e/1FAIpQLSdgFSfxnOi0x5OVJxdc85JVQRHa9dVdupvOzxTt5xzpocuNVQ/viewform)
...
::: {.callout-tip icon=false}
### Definición — Espacio muestral discreto y continuo
...
## Definición — Suceso imposible y seguro
...
Si se define el evento $A$ como: "obtener un 4", entonces $A$ es un **evento simple**.

$A = \{4\}$, con $P(A) = \dfrac{1}{6}$.
:::
...
Si se define el evento $A$ como: "obtener dos escudos", entonces $A$ es un **evento simple**.

$A = \{\{E,E\}\}$, con $P(A) = \dfrac{1}{4}$.
:::
...
**Queremos demostrar** que el evento "$A$ pero no $B$" coincide con $A \cap B^c$.
...
**($\supseteq$)** Sea $\omega \in A \cap B^c$. Entonces:
